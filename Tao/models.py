...
class SaleOrder(models.Model):
    ...
    # )
    # index_weight = 2
    # name = models.CharField('订单号码',max_length=const.DB_CHAR_NAME_20,blank=True,null=True)
    # client_order_ref = models.CharField('客户关联单号',max_length=const.DB_CHAR_NAME_40)
    # create_date = models.DateField('单据日期')
    # partner_id = models.ForeignKey(Partner,on_delete=models.CASCADE,verbose_name=_("partner"),limit_choices_to={"partner_type":"C"})
    ...
    #
    # def save1(self, force_insert=False, force_update=False, using=None,
    #          update_fields=None):
